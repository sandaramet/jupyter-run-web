...
/* harmony import */ var _components_header_header_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/header/header.module */ "./src/app/components/header/header.module.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_10__["AngularFireModule"].initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_11__["environment"].firebaseConfig, 'jupyter-run-dev'),
...
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/__ivy_ngcc__/fesm2015/ionic-angular.js");
/* harmony import */ var _settings_popover_settings_popover_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./settings-popover/settings-popover.component */ "./src/app/components/header/settings-popover/settings-popover.component.ts");
...
let HeaderComponent = class HeaderComponent {
    constructor(router, auth, popoverController) {
        this.router = router;
        this.auth = auth;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SettingsPopoverComponent", function() { return SettingsPopoverComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/auth.service */ "./src/app/services/auth.service.ts");
...
let SettingsPopoverComponent = class SettingsPopoverComponent {
    constructor(router, auth, popoverController, document) {
        this.router = router;
        this.auth = auth;
        this.popoverController = popoverController;
...
SettingsPopoverComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-settings-popover',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./settings-popover.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/header/settings-popover/settings-popover.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./settings-popover.component.scss */ "./src/app/components/header/settings-popover/settings-popover.component.scss")).default]
    }),
...
let AuthService = class AuthService {
    constructor(firebase, router, ngZone, jwtHelper, afs) {
    ...
    updateUserData(keys) {
        const userRef = this.afs.doc(`service-accounts/${JSON.parse(localStorage.getItem('user_uid'))}`);
        const data = {
    ...
    verifyEmail() {
        this.firebase.authState.subscribe((user) => {
            if (user) {
                ...
                localStorage.setItem('user_uid', JSON.stringify(this.userData.uid));
    ...
    GoogleAuth() {
        ...
        return this.firebase.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_3__["auth"].GoogleAuthProvider()).then((data) => {
            if (data['operationType'] == 'signIn') {
                this.firebase.authState.subscribe((user) => {
                    if (user) {
                        ...
                        JSON.parse(localStorage.getItem('user'));
                        localStorage.setItem('user_uid', JSON.stringify(this.userData.uid));
                        localStorage.setItem('user_name', JSON.stringify(this.userData.displayName));
                        localStorage.setItem('user_email', JSON.stringify(this.userData.email));
...
module.exports = __webpack_require__(/*! /home/sandaramet/Documents/jupyter-run/src/main.ts */"./src/main.ts");

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-sign-in-sign-in-module"], {
  ...
  function srcAppPagesSignInSignInModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    SignInPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _sign_in_routing_module__WEBPACK_IMPORTED_MODULE_5__["SignInPageRoutingModule"], src_app_components_header_header_module__WEBPACK_IMPORTED_MODULE_7__["HeaderModule"]],
  ...
  function srcAppPagesSignInSignInPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignInPage = /*#__PURE__*/function () {
      function SignInPage(auth, alertController, router) {
      ...
      _createClass(SignInPage, [{
        ...
        key: "authMail",
        value: function authMail() {
          var _this = this;

          this.auth.SignIn(this.user.email, this.user.password).then(function (data) {
            console.log(data);
            if (data.user && data.user.emailVerified !== true) _this.presentAlert("Please validate your email address. Kindly check your inbox.", "You successfully registered", function () {
              return _this.router.navigateByUrl("/sign-in");
            });else if (data.message) _this.presentAlert(data.message);
          });
        }
      }, {
        key: "authGithub",
